...
CREATE TABLE IF NOT EXISTS `socialite`.`Association` (
  ...
  UNIQUE INDEX `idGroup_UNIQUE` (`idAssociation` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `socialite`.`UserAssociation` (
  ...
  INDEX `fk_UserGroup_Group_idx` (`association` ASC) VISIBLE,
...
INSERT INTO `socialite`.`UserFriend` (`idUser`, `idFriend`) VALUES (, DEFAULT);
