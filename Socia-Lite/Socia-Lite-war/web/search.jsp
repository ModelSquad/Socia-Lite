<%-- 
    Document   : search
    Created on : May 11, 2019, 11:52:47 PM
    Author     : Sevi
--%>
...
<link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">    
    ...
    <body>
        ...
        List<User> search = (List) request.getAttribute("search");
        search.remove(user);
        ...
        <div class="row content">
            ...
            <div class="card gedf-card mt-0 mb-3" style="width: 100%;">     
                <div class="d-flex justify-content-between align-items-center">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="m-2">
                            <img class="rounded-circle" width="45" src="<%=(s.getProfilePic() == null) 
                      ? "https://cdn.clipart.email/0ad2ce5b5370f2d91ef8b465f6770e77_people-icons-3800-free-files-in-png-eps-svg-format_338-338.jpeg" 
                      : s.getProfilePic() %>" alt="">
                        </div>
                        <div class="ml-2">
                            <div class="h5 m-0"><a href="ProfileServlet?user=<%=s.getIdUser()%>"><%=s.getNickname()%></a></div>
                            <div class="h7 text-muted"><%=s.getName()%></div>
                        </div>
                    </div>
                    <div>
                        <div class="btn-group btn-group-justified m-2 mr-4" >
                            <a class="btn btn-xs btn-primary" href="ProfileServlet?user=<%=s.getIdUser()%>" data-target="#" ><i class="material-icons" style="font-size:20px;">remove_red_eye</i>See profile</a>
                        </div>
                    </div>
                </div> 
            </div>
