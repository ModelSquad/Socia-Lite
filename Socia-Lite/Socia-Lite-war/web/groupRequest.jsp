            ...
            <div class="row content">
                ...
                <div class="col-sm text-left feed">
                    <div class="btn-group" role="group">
                        ...
                        <a href="groupRequest.jsp" class="btn btn-selection btn-selected">Group Request</a>
                    </div> 
                <% 
                        ...
                        for(Association association : admin){
                            ...
                            if(requests.size()>0){
                                %>
                            <p><%=association.getName()%>  <span class="badge badge-danger"><%=requests.size()%></span></p>
                         <% 
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <div class="btn-group btn-group-justified m-2 mr-4" >
                                        <a href="AceptAssociationRequestServlet?associationRequestId=<%=associationRequest.getAssociationRequestId()%>" class="btn btn-xs btn-primary"><i class="material-icons" style="font-size:20px;">done</i></span> Acept</a>
                                        <a href="DenyAssociationRequestServlet?associationRequestId=<%=associationRequest.getAssociationRequestId()%>" class="btn btn-xs btn-danger "><i class="material-icons" style="font-size:20px;">clear</i> Deny   </a>
                                    </div>
                                </div>
                            </div>
                        </div>
