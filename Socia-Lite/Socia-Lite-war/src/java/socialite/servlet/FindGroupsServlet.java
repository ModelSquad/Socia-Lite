 ...
 * @author cherra
 */
@WebServlet(name = "FindGroupsServlet", urlPatterns = {"/FindGroupsServlet"})
public class FindGroupsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(user != null){
            List<Association> notAssociation = associationFacade.findNotAssociation(user);
            session.setAttribute("notGroups", notAssociation);
            response.sendRedirect("findGroups.jsp");
        } else {
